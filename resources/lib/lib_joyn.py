	...
	def get_auth_token(self,
		...
		if username is not None and password is not None:
			try:
				...
				# ENDPOINTS
				a = t.get(f"https://auth.joyn.de/sso/endpoints?client_id={}&client_name=web", client_id, headers=h)
				endpoints = a.json()
				...
				# PREFLIGHTS
				a = t.get(f"https://auth.7pass.de/token-srv/prelogin/metadata/{}?acceptLanguage=de-de", id_dict_2['cd1'])
